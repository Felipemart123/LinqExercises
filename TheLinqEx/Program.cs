...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var theSum = numbers.Sum();
            Console.WriteLine(theSum);
            //TODO: Print the Average of numbers
            var theAveragenum = numbers.Average();
            Console.WriteLine(theAveragenum);
            ...
            foreach (var num in ordered.Take(4))
            {
                Console.WriteLine(num);
            }
            ...
            var empName = employees.Where(name => name.FirstName.ToLower().StartsWith('c') || name.FirstName.ToLower().StartsWith('s'));
